# 📱 DeepDroid Custom ROM Flashing Guide
...
On your computer, run the following command to start installing the DeepDroid ROM:

```bash
adb sideload deepdroid_rom.zip
```
...
After sideloading, go back to the Recovery menu and select **Reboot System Now** to boot into DeepDroid.
